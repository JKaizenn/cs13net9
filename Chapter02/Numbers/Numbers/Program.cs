...
//This section shows how doubles can store much larger values than decimal even though they use twice as less memory.
...
decimal c = 0.1M; //M Sufflix means a decimal literal value
decimal d = 0.2M;
...
Console.WriteLine($"Int128 uses {sizeof(Int128)} bytes and can storenumbers in the range {Int128.MinValue:N0} to {Int128.MaxValue:N0}.");
}