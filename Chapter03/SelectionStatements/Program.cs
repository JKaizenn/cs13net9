...
class Program
{
    static void Main(string[] args)
    {
        ...
        /* The switch statement compares a single expression against a list of multiple
        possible case statements. Every case statement is related to the single expression.*/
